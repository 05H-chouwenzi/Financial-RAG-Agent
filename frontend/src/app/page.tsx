    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-7xl px-6 pt-12 pb-8 text-center">
        <h1 className="text-5xl font-bold leading-tight tracking-tight text-foreground sm:text-6xl">
          FinFlow 金融研报<span className="text-destructive">RAG</span>智能检索助手
        </h1>
        <p className="mx-auto mt-4 max-w-2xl text-base text-muted-foreground">
          RAG-Based Intelligent Financial Report & Chart Retrieval Agent
        </p>
        <p className="mx-auto mt-3 max-w-3xl text-sm text-muted-foreground/80">
          智能体平台融合 Agentic RAG 与多模态 RAG 双引擎，帮助分析师快速、准确检索金融研报图表。
        </p>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-6">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <Link href="/knowledge" className="block cursor-pointer">
            <SearchCard
              title="知识库管理"
              description="统一管理金融研报与标准图表，支持用户上传 PDF 等文件入库，支持分类浏览与快速定位"
              image="/ill-3.png"
          ...
          <Link href="/search?category=standard" className="block cursor-pointer">
            <SearchCard
              title="研报检索"
              description="基于 Agentic RAG 构建研报知识库，支持多轮推理与来源溯源，实现研报问答的智能回答"
              image="/ill-4.png"
          ...
          <Link href="/search?category=atlas" className="block cursor-pointer">
            <SearchCard
              title="图表检索"
              description="基于多模态 RAG 处理研报图表，支持文字描述与图表截图双向检索，快速定位关键数据图表"
        ...
        {/* Search Input */}
        <div className="mt-8 mx-auto w-full max-w-2xl px-6">
          <Link
            href="/search"
